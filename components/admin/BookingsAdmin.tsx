    ...
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        {[
          ...
          {
            label: "Ingresos Est.",
            value: stats.revenue.toLocaleString("es-CL", {
              style: "currency",
              currency: "CLP",
            }),
            icon: BedDouble,
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full sm:w-auto">
          <div className="relative w-full sm:w-72">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white/[0.05] border border-white/10 text-white text-sm placeholder:text-white/30 focus:outline-none focus:ring-2 focus:ring-[var(--primary)]/50 transition-all"
            />
          </div>
          <div className="relative">
            ...
            <select
              ...
              className="appearance-none pl-9 pr-8 py-2.5 rounded-xl bg-white/[0.05] border border-white/10 text-white text-sm focus:outline-none cursor-pointer"
            >
              <option value="todas" className="bg-[#2b2b2b]">
                Todos los estados
              </option>
              {(Object.keys(STATUS_CONFIG) as BookingStatus[]).map((s) => (
                <option key={s} value={s} className="bg-[#2b2b2b]">
        ...
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 bg-[var(--primary)] text-white rounded-xl text-sm font-semibold hover:bg-[var(--primary)]/80 transition-colors cursor-pointer shadow-lg shadow-[var(--primary)]/20"
        >
            ...
            filtered.map((booking, idx) => {
              ...
              return (
                ...
                >
                  {/* Status Badge */}
                  <div
                    className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border text-xs font-semibold ${sc.bg} ${sc.color}`}
                  >
                  ...
                  <div className="text-xs text-white/50 whitespace-nowrap">
                    ...
                    <p className="text-white/30">
                      {getNights(booking.checkIn, booking.checkOut)} noche(s)
                    </p>
                  </div>
                  {/* Price */}
        ...
        {selectedBooking && (
          ...
          >
            <motion.div
              ...
              className="bg-[#2a2a2a] rounded-2xl w-full max-w-lg border border-white/10 shadow-2xl overflow-hidden"
            >
              ...
              <div className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                ...
                {(() => {
                  const sc =
                    STATUS_CONFIG[selectedBooking.status as BookingStatus] ||
                    STATUS_CONFIG.pendiente;
                  const SI = sc.icon;
                  return (
                    <div
                      className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl border text-sm font-semibold ${sc.bg} ${sc.color}`}
                    >
                      <SI size={16} />
                      {sc.label}
                    </div>
                ...
                <div className="p-3 rounded-xl bg-white/5 border border-white/5">
                  ...
                  <p className="text-xs text-white/30 capitalize">
                    {selectedBooking.room?.category}
                  </p>
                </div>
                {selectedBooking.notes && (
                  <div className="p-3 rounded-xl bg-white/5 border border-white/5">
                    <p className="text-[10px] text-white/40 uppercase flex items-center gap-1">
                      <StickyNote size={12} />
                      Notas
                    </p>
              ...
              >
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary)]/50"
                    />
                  </div>
                  <div>
                    <label className="block text-xs text-white/40 mb-1">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white text-sm focus:outline-none cursor-pointer"
                    >
                      <option value="" className="bg-[#2b2b2b]">
                        Seleccionar...
                      </option>
                      {rooms.map((r) => (
                        <option
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full px-3 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary)]/50 resize-none"
                  />
                </div>
                {formError && (
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2.5 rounded-xl bg-[var(--primary)] text-white text-sm font-semibold hover:bg-[var(--primary)]/80 transition-colors cursor-pointer disabled:opacity-50"
                  >
                    {formSubmitting ? "Guardando..." : "Crear Reserva"}
                  </button>
                </div>
              </form>
            </motion.div>
